...
public class DummyData {
    ...
    @Autowired
    BlogRepositorio repositorio;

    //A ANOTAÇÃO ABAIXO INDICA QUE TUDO COLOCADO DENTRO DESSE MÉTODO VAI SER CONSTRUIDO COM O UP DO PROJETO
    // USA SÓ UMA VEZ
    //@PostConstruct
    public void savePosts(){
        ...
        for(Post post: postList){
            Post postSaved = repositorio.save(post);
